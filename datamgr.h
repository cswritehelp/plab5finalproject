...
/**
 *  This method holds the core functionality of your datamgr. It takes in 1 file pointer to the sensor map file, 1 pointer to pointer to sbuffer(shared data structure) and parses them. 
 *  When the method finishes all data should be in the internal pointer list and all log messages should be printed to stderr.
 *  \param fp_sensor_map file pointer to the map file
 *  \param sbuffer a pointer to shared data structure sbuffer
 */
